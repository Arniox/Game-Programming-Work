...
FinishLine::FinishLine(b2World* pWorld, int x, int y, float _M2P, float _P2M)
{
	...
	m_pSprite = Game::GetBackBuffer()->CreateSprite("assets\\Textures\\Sprites\\finishline.png");
...
void
FinishLine::Draw(BackBuffer & backBuffer)
{
